...
public class UserSpringDaoJdbc implements UserSpringDao {
	...
	public void add(User user){
		this.jdbcTemplate.update("insert into users(userid, name, password, level, login, recommend) values (?,?,?,?,?,?)",
	...
	public void update(User user) {
		this.jdbcTemplate.update("update users set name = ? , password = ?, level = ? , login = ? , recommend = ? where userid = ?",
